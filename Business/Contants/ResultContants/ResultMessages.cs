namespace Business.Contants.ResultContants
{
    public static class ResultMessages
    {
        ...
        public static string UserHasNotRegisteredBefore = "User has not registered before.";

        public static string PasswordNotMatch = "Password was not match!";
        public static string PasswordError = "Password was mistakes.";
